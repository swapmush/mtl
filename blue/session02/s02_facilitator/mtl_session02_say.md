---
title: "MTL Session 02 - Facilitator Say Guide"
author: "Team PSD"
date: " March 17 2022"
release: "MTL 3.0"
output: 
...
## Today we're _Modeling to Learn_ from our patient data and team trends.
...
_**Modeling to Learn**_ can help us to get more of our Veterans to the right care in the right time to meet their needs using participatory learning from simulation.
...
- Clinics and data not populating? Request and verify your local server views [described at the bottom of the See guide](https://github.com/lzim/mtl/blob/master/blue/session02/s02_learner/mtl_session02_see.md#request-and-verify-local-server-view-permissions).
